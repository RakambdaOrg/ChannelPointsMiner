...
NOTE: If you have 2FA enabled you'll have to enter your token the first time in order to login. As Docker doesn't give an interractive shell by default you'll have to run the container in interractive mode yourself the first time. More can be read about it in #87.
