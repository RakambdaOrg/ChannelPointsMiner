...
Examples can be found in link:https://github.com/RakSrinaNa/ChannelPointsMiner/blob/main/src/test/resources/config[src/test/resources/config,window="_blank"].
