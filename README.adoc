...
|kelly
|Chose the outcome following link:https://en.wikipedia.org/wiki/Kelly_criterion[Kelly criterion].
|See link:https://en.wikipedia.org/wiki/Kelly_criterion#Gambling_formula[Kelly criterion].
|
|===
...
|kelly
|Place points following link:https://en.wikipedia.org/wiki/Kelly_criterion[Kelly criterion].
|See link:https://en.wikipedia.org/wiki/Kelly_criterion#Gambling_formula[Kelly criterion].
|* percentage: Percentage of Kelly criterion result to place, as a decimal value, between `0` and `1`.

Example: If Kelly says we should place 500 points and you set the percentage to `0.5` then only 250 points will be placed.
