package fr.raksrinana.channelpointsminer.miner.api.ws.data.message.activemultipliersupdated;
...
@ToString
@Builder
public class ActiveMultipliersUpdatedData{
	...
	@NotNull
	private ActiveMultipliers activeMultipliers;
}
