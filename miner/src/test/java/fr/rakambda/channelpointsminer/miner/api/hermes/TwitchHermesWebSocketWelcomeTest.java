...
class TwitchHermesWebSocketWelcomeTest{
	...
	void onResponse(WebsocketMockServer server) throws InterruptedException{
		...
		server.send(TestUtils.getAllResourceContent("api/hermes/welcome_ok.json"));
		
		var expected = WelcomeResponse.builder()
				.id("4ae4865b-cedc-4755-8335-0560b7d05341")
				.timestamp(ZonedDateTime.parse("2025-01-02T03:04:05.123456789Z"))
				.welcome(WelcomeResponse.Welcome.builder()
						.keepaliveSec(15)
						.build())
				.build();
