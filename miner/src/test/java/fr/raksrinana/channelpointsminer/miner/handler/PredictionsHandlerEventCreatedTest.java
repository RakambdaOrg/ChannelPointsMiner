...
import static fr.raksrinana.channelpointsminer.miner.api.ws.data.message.subtype.EventStatus.ACTIVE;
import static fr.raksrinana.channelpointsminer.miner.api.ws.data.message.subtype.EventStatus.LOCKED;
