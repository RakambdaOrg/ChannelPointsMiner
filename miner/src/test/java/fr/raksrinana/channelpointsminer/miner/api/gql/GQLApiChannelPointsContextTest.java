...
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.ChannelSelfEdge;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsAutomaticReward;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsChannelEarningSettings;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsChannelSettings;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsClaim;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsEmote;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsEmoteModification;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsEmoteVariant;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsImage;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsLastViewedContentByType;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsLastViewedContentByTypeAndID;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsMultiplier;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsProperties;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsUserProperties;
import fr.raksrinana.channelpointsminer.miner.api.gql.data.types.CommunityPointsWatchStreakEarningSettings;
...
import static fr.raksrinana.channelpointsminer.miner.api.gql.data.types.ContentId.SINGLE_MESSAGE_BYPASS_SUB_MODE;
import static fr.raksrinana.channelpointsminer.miner.api.gql.data.types.ContentType.AUTOMATIC_REWARD;
