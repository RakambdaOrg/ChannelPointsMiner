...
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsAutomaticReward;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsChannelEarningSettings;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsChannelSettings;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsClaim;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsEmote;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsEmoteModification;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsEmoteVariant;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsImage;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsLastViewedContentByType;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsLastViewedContentByTypeAndID;
...
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsUserProperties;
import fr.raksrinana.channelpointsminer.api.gql.data.types.CommunityPointsWatchStreakEarningSettings;
...
import fr.raksrinana.channelpointsminer.api.gql.data.types.UserSelfConnection;
...
import static fr.raksrinana.channelpointsminer.api.gql.data.types.ContentId.SINGLE_MESSAGE_BYPASS_SUB_MODE;
import static fr.raksrinana.channelpointsminer.api.gql.data.types.ContentType.AUTOMATIC_REWARD;
import static fr.raksrinana.channelpointsminer.api.gql.data.types.ContentType.CUSTOM_REWARD;
import static fr.raksrinana.channelpointsminer.api.gql.data.types.RewardType.SEND_HIGHLIGHTED_MESSAGE;
