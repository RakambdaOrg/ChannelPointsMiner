package fr.raksrinana.channelpointsminer.api.helix;

import fr.raksrinana.channelpointsminer.api.helix.data.follows.Follow;
import fr.raksrinana.channelpointsminer.api.helix.data.follows.GetFollowsResponse;
